var app = angular.module('meanapp', ['ngRoute', 'ngResource']);
...
app.controller('EditVideoCtrl',['$scope','$resource','$location','$routeParams', function($scope, $resource, $location, $routeParams){
	// By default you cannot send HTTP PUT requests using $resource service.
	// You need to extend it by adding an update method that uses HTTP PUT.
